...
const navigationMenuTriggerStyle = cva(
  "ygroup yinline-flex yh-9 yw-max yitems-center yjustify-center yrounded-md ybg-background ypx-4 ypy-2 ytext-sm yfont-medium ytransition-colors hover:ybg-accent hover:ytext-accent-foreground focus:ybg-accent focus:ytext-accent-foreground focus:youtline-none disabled:ypointer-events-none disabled:yopacity-50 data-[active]:ybg-accent/50 data-[state=open]:ybg-accent/50"
)
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}{" "}
    <ChevronDownIcon
      className="yrelative ytop-[1px] yml-1 yh-3 yw-3 ytransition yduration-300 group-data-[state=open]:yrotate-180"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
))
...
>(({ className, ...props }, ref) => (
  <div className={cn("yabsolute yleft-0 ytop-full yflex yjustify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "yorigin-top-center yrelative ymt-1.5 yh-[var(--radix-navigation-menu-viewport-height)] yw-full yoverflow-hidden yrounded-md yborder ybg-popover ytext-popover-foreground yshadow data-[state=open]:yanimate-in data-[state=closed]:yanimate-out data-[state=closed]:yzoom-out-95 data-[state=open]:yzoom-in-90 md:yw-[var(--radix-navigation-menu-viewport-width)]",
        className
      )}
      ref={ref}
      {...props}
