...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "yz-50 ymin-w-[8rem] yoverflow-hidden yrounded-md yborder ybg-popover yp-1 ytext-popover-foreground yshadow-md",
        "data-[state=open]:yanimate-in data-[state=closed]:yanimate-out data-[state=closed]:yfade-out-0 data-[state=open]:yfade-in-0 data-[state=closed]:yzoom-out-95 data-[state=open]:yzoom-in-95 data-[side=bottom]:yslide-in-from-top-2 data-[side=left]:yslide-in-from-right-2 data-[side=right]:yslide-in-from-left-2 data-[side=top]:yslide-in-from-bottom-2",
        className
      )}
      {...props}
    />
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span className="yabsolute yleft-2 yflex yh-3.5 yw-3.5 yitems-center yjustify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        <DotFilledIcon className="yh-4 yw-4 yfill-current" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
