...
const CommandDialog = ({ children, ...props }: CommandDialogProps) => {
  return (
    <Dialog {...props}>
      <DialogContent className="yoverflow-hidden yp-0">
...
>(({ className, ...props }, ref) => (
  <div className="yflex yitems-center yborder-b ypx-3" cmdk-input-wrapper="">
    <MagnifyingGlassIcon className="ymr-2 yh-4 yw-4 yshrink-0 yopacity-50" />
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "yflex yh-10 yw-full yrounded-md ybg-transparent ypy-3 ytext-sm youtline-none placeholder:ytext-muted-foreground disabled:ycursor-not-allowed disabled:yopacity-50",
        className
      )}
      {...props}
    />
